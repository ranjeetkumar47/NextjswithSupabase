...
import { setTheme, getStoredTheme, isDarkSystemTheme, DARK_THEME_CLASSNAME, LIGHT_THEME_CLASSNAME, SYSTEM_THEME_CLASSNAME } from '@/core/theming'
    ...
    <Select value={currentTheme} onValueChange={setCurrentTheme}>
      ...
      <SelectContent position={'popper'} sideOffset={5}>
        <SelectGroup>
          ...
          <SelectItem data-cy={'light-theme-button'} value={LIGHT_THEME_CLASSNAME}>
          ...
          <SelectItem data-cy={'system-theme-button'} value={SYSTEM_THEME_CLASSNAME}>
            <span className={'flex items-center space-x-2.5'}>
